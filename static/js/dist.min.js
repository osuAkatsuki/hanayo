...
function showIdMessage(e, t, id) {
    var n = $('<div id="' + id + '" class="ui ' + e + ' message hidden"><i class="close icon"></i>' + T(t) + "</div>");
...
function api(e, t, n, i, o) {
    ...
    $.ajax({
        ...
        error: function(e, t, n) {
            if (e.status >= 400 && e.status < 500 && "function" == typeof i) return void i(e.responseJSON);
            console.warn(e, t, n), showMessage("error", r)
        }
    })
}
...
function privilegesToString(e) {
    ...
    function a(e, t, n) {
        return be(t) ? we.grep(e, function(e, i) {
    ...
    function l(e) {
        var t = {};
        return we.each(e.match(Pe) || [], function(e, n) {
            t[n] = !0
        }), t
    }
    ...
    function h(e) {
        return e.replace(Fe, "ms-").replace(Me, p)
    }
    ...
    function b(e, t, n, i) {
        ...
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; a--;) we.style(e, t, u + c), (1 - r) * (1 - (r = s() / l || .5)) <= 0 && (a = 0), u /= r;
    ...
    function y(e) {
        var t, n = e.ownerDocument,
            i = e.nodeName,
            o = Ke[i];
        return o || (t = n.body.appendChild(n.createElement(i)), o = we.css(t, "display"), t.parentNode.removeChild(t), "none" === o && (o = "block"), Ke[i] = o, o)
    }

    function x(e, t) {
        for (var n, i, o = [], r = 0, a = e.length; r < a; r++)(i = e[r]).style && (n = i.style.display, t ? ("none" === n && (o[r] = He.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && _e(i) && (o[r] = y(i))) : "none" !== n && (o[r] = "none", He.set(i, "display", n)));
    ...
    function k(e, t, n, o, r) {
        for (var a, s, l, c, u, d, f = t.createDocumentFragment(), p = [], h = 0, g = e.length; h < g; h++)
            if ((a = e[h]) || 0 === a)
                if ("object" === i(a)) we.merge(p, a.nodeType ? [a] : a);
                else if (Ze.test(a)) {
            for (s = s || f.appendChild(t.createElement("div")), l = (Je.exec(a) || ["", ""])[1].toLowerCase(), c = Ye[l] || Ye._default, s.innerHTML = c[1] + we.htmlPrefilter(a) + c[2], d = c[0]; d--;) s = s.lastChild;
            we.merge(p, s.childNodes), (s = f.firstChild).textContent = ""
        } else p.push(t.createTextNode(a));
        for (f.textContent = "", h = 0; a = p[h++];)
            if (o && we.inArray(a, o) > -1) r && r.push(a);
            else if (u = we.contains(a.ownerDocument, a), s = w(f.appendChild(a), "script"), u && C(s), n)
    ...
    function L(e, t, i, o) {
        ...
        if (f && (r = k(t, e[0].ownerDocument, !1, e, o), a = r.firstChild, 1 === r.childNodes.length && (r = a), a || o)) {
            for (l = (s = we.map(w(r, "script"), D)).length; d < f; d++) c = r, d !== p && (c = we.clone(c, !0, !0), l && we.merge(s, w(c, "script"))), i.call(e[d], c, d);
            if (l)
    ...
    function q(e, t, n) {
        for (var i, o = t ? we.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || we.cleanData(w(i)), i.parentNode && (n && we.contains(i.ownerDocument, i) && C(w(i, "script")), i.parentNode.removeChild(i));
        return e
    }

    function N(e, t, n) {
        var i, o, r, a, s = e.style;
        return (n = n || ct(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || we.contains(e.ownerDocument, e) || (a = we.style(e, t)), !ve.pixelBoxStyles() && lt.test(a) && ut.test(t) && (i = s.width, o = s.minWidth, r = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = i, s.minWidth = o, s.maxWidth = r)), void 0 !== a ? a + "" : a
    }
    ...
    function $(e, t, n, i, o, r) {
        ...
        for (; a < 4; a += 2) "margin" === n && (l += we.css(e, n + Be[a], !0, o)), i ? ("content" === n && (l -= we.css(e, "padding" + Be[a], !0, o)), "margin" !== n && (l -= we.css(e, "border" + Be[a] + "Width", !0, o))) : (l += we.css(e, "padding" + Be[a], !0, o), "padding" !== n ? l += we.css(e, "border" + Be[a] + "Width", !0, o) : s += we.css(e, "border" + Be[a] + "Width", !0, o));
    ...
    function V() {
        bt && (!1 === ae.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(V) : e.setTimeout(V, we.fx.interval), we.fx.tick())
    }
    ...
    function X(e, t, n) {
        ...
        for (i in t)
            ...
            d && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = m && m.display) && (c = He.get(e, "display")), "none" === (u = we.css(e, "display")) && (c ? u = c : (x([e], !0), c = e.style.display || c, u = we.css(e, "display"), x([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === we.css(e, "float") && (l || (f.done(function() {
                h.display = c
            }), null == c && (u = h.display, c = "none" === u ? "" : u)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", f.always(function() {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            })), l = !1;
            for (i in p) l || (m ? "hidden" in m && (g = m.hidden) : m = He.access(e, "fxshow", {
                display: c
            }), r && (m.hidden = !g), g && x([e], !0), f.done(function() {
                g || x([e]), He.remove(e, "fxshow");
                for (i in p) we.style(e, i, p[i])
            })), l = _(g ? m[i] : 0, i, f), i in m || (m[i] = l.start, g && (l.end = l.start, l.start = 0))
        }
    }
    ...
    function K(e, t) {
        var n, i, o, r, a;
        for (n in e)
            if (i = h(n), o = t[i], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (a = we.cssHooks[i]) && "expand" in a) {
    ...
    function Q(e, t, n) {
        var i, o, r = 0,
            ...
            l = function() {
                if (o) return !1;
                for (var t = vt || W(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, a = c.tweens.length; r < a; r++) c.tweens[r].run(i);
            ...
            u = c.props;
        for (K(u, c.opts.specialEasing); r < a; r++)
            if (i = Q.prefilters[r].call(c, e, u, c.opts)) return be(i.stop) && (we._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return we.map(u, _, c), be(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), we.fx.timer(we.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    we.fn = we.prototype = {
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (o(Object(e)) ? we.merge(n, "string" == typeof e ? [e] : e) : ue.call(n, e)), n
        },
    ...
    var ke = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : H) !== O && R(t), t = t || O, L)) {
                if (11 !== h && (l = ge.exec(e)))
                    if (o = l[1]) {
                        if (9 === h) {
                    ...
                    if (1 !== h) p = t, f = e;
                        ...
                        for ((s = t.getAttribute("id")) ? s = s.replace(ye, xe) : t.setAttribute("id", s = I), r = (u = T(e)).length; r--;) u[r] = "#" + s + " " + d(u[r]);
        ...
        function m(e, t, n, o, r, a) {
            return o && !o[I] && (o = m(o)), r && !r[I] && (r = m(r, a)), i(function(i, a, s, l) {
                var c, u, d, f = [],
                    ...
                    y = n ? r || (i ? e : m || o) ? [] : a : b;
                if (n && n(b, y, s, l), o)
                    for (c = g(y, p), o(c, [], s, l), u = c.length; u--;)(d = c[u]) && (y[p[u]] = !(b[p[u]] = d));
                if (i) {
                    if (r || e) {
                        if (r) {
                        ...
                        for (u = y.length; u--;)(d = y[u]) && (c = r ? Y(i, d) : f[u]) > -1 && (i[c] = !(a[c] = d))
                    }
                } else y = g(y === a ? y.splice(m, y.length) : y), r ? r(null, a, y, l) : J.apply(a, y)
            })
        }
            ...
            var o = n.length > 0,
                ...
                a = function(i, a, s, l, c) {
                    var u, d, f, p = 0,
                        ...
                        C = y.length;
                    for (c && (E = a === O || a || c); h !== C && null != (u = y[h]); h++) {
                        if (r && u) {
                            for (d = 0, a || u.ownerDocument === O || (R(u), s = !L); f = e[d++];)
                                if (f(u, a || O, s)) {
                                    l.push(u);
                                    break
                                } c && ($ = x)
        ...
        var y, x, w, C, k, T, S, A, E, j, D, R, O, P, L, q, N, F, M, I = "sizzle" + 1 * new Date,
            H = e.document,
            $ = 0,
            z = 0,
            U = n(),
        ...
        try {
            J.apply(X = G.call(H.childNodes), H.childNodes), X[H.childNodes.length].nodeType
        } catch (e) {
            J = {
        ...
        x = t.support = {}, k = t.isXML = function(e) {
            ...
            return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, P = O.documentElement, L = !k(O), H !== O && (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), x.attributes = o(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), x.getElementsByTagName = o(function(e) {
                return e.appendChild(O.createComment("")), !e.getElementsByTagName("*").length
            }), x.getElementsByClassName = he.test(O.getElementsByClassName), x.getById = o(function(e) {
                return P.appendChild(e).id = I, !O.getElementsByName || !O.getElementsByName(I).length
            ...
            }, N = [], q = [], (x.qsa = he.test(O.querySelectorAll)) && (o(function(e) {
                ...
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && q.push("name" + ee + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && q.push(":enabled", ":disabled"), P.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && q.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), q.push(",.*:")
            })), (x.matchesSelector = he.test(F = P.matches || P.webkitMatchesSelector || P.mozMatchesSelector || P.oMatchesSelector || P.msMatchesSelector)) && o(function(e) {
                x.disconnectedMatch = F.call(e, "*"), F.call(e, "[s!='']:x"), N.push("!=", ie)
            }), q = q.length && new RegExp(q.join("|")), N = N.length && new RegExp(N.join("|")), t = he.test(P.compareDocumentPosition), M = t || he.test(P.contains) ? function(e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === H && M(H, e) ? -1 : t === O || t.ownerDocument === H && M(H, t) ? 1 : j ? Y(j, e) - Y(j, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return D = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
                    ...
                    s = [e],
                    l = [t];
                if (!o || !r) return e === O ? -1 : t === O ? 1 : o ? -1 : r ? 1 : j ? Y(j, e) - Y(j, t) : 0;
                if (o === r) return a(e, t);
            ...
            if ((e.ownerDocument || e) !== O && R(e), n = n.replace(le, "='$1']"), x.matchesSelector && L && !W[n + " "] && (!N || !N.test(n)) && (!q || !q.test(n))) try {
                var i = F.call(e, n);
                if (i || x.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
            } catch (e) {}
            return t(n, O, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== O && R(e), M(e, t)
        }, t.attr = function(e, t) {
            (e.ownerDocument || e) !== O && R(e);
            var n = w.attrHandle[t.toLowerCase()],
                i = n && _.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !L) : void 0;
            ...
            var t, n = [],
                i = 0,
                o = 0;
            if (D = !x.detectDuplicates, j = !x.sortStable && e.slice(0), e.sort(B), D) {
            ...
            filter: {
                    ...
                    return 1 === i && 0 === o ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [a ? m.firstChild : m.lastChild], a && b) {
                                for (y = (p = (c = (u = (d = (f = m)[I] || (f[I] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === $ && c[1]) && c[2], f = p && m.childNodes[p]; f = ++p && f && f[g] || (y = p = 0) || h.pop();)
                                    if (1 === f.nodeType && ++y && f === t) {
                                        u[e] = [$, p, y];
                                        break
                                    }
                            } else if (b && (y = p = (c = (u = (d = (f = t)[I] || (f[I] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === $ && c[1]), !1 === y)
                                for (;
                                    (f = ++p && f && f[g] || (y = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++y || (b && ((u = (d = f[I] || (f[I] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [$, y]), f !== t)););
                ...
                PSEUDO: function(e, n) {
                    ...
                    return r[I] ? r(n) : r.length > 1 ? (o = [e, e, "", n], w.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function(e, t) {
                        for (var i, o = r(e, n), a = o.length; a--;) e[i = Y(e, o[a])] = !(t[i] = o[a])
                    }) : function(e) {
                        return r(e, 0, o)
                    }) : r
                }
        ...
        return u.prototype = w.filters = w.pseudos, w.setFilters = new u, T = t.tokenize = function(e, n) {
            ...
            var n, i = [],
                ...
                r = W[e + " "];
            if (!r) {
                for (t || (t = T(e)), n = t.length; n--;)(r = v(t[n]))[I] ? i.push(r) : o.push(r);
                (r = W(e, b(o, i))).selector = e
            }
            return r
            ...
            if (n = n || [], 1 === f.length) {
                if ((r = f[0] = f[0].slice(0)).length > 2 && "ID" === (a = r[0]).type && 9 === t.nodeType && L && w.relative[r[1].type]) {
                ...
                for (o = de.needsContext.test(e) ? 0 : r.length; o-- && (a = r[o], !w.relative[s = a.type]);)
                    if ((l = w.find[s]) && (i = l(a.matches[0].replace(ve, be), me.test(r[0].type) && c(t.parentNode) || t))) {
                        if (r.splice(o, 1), !(e = i.length && d(r))) return J.apply(n, i), n;
                        break
                    }
            }
            return (u || S(e, f))(i, t, !L, n, !t || me.test(e) && c(t.parentNode) || t), n
        }, x.sortStable = I.split("").sort(B).join("") === I, x.detectDuplicates = !!D, R(), x.sortDetached = o(function(e) {
    ...
    we.filter = function(e, t, n) {
        ...
        is: function(e) {
            return !!a(this, "string" == typeof e && Ae.test(e) ? we(e) : e || [], !1).length
        }
    });
    var je, De = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (we.fn.init = function(e, t, n) {
        ...
        return e.nodeType ? (this[0] = e, this.length = 1, this) : be(e) ? void 0 !== n.ready ? n.ready(e) : e(we) : we.makeArray(e, this)
    }).prototype = we.fn, je = we(ae);
    ...
    we.fn.extend({
        ...
        we.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = we.filter(i, o)), this.length > 1 && (Oe[e] || we.uniqueSort(o), Re.test(e) && o.reverse()), this.pushStack(o)
        }
    });
    var Pe = /[^\x20\t\r\n\f]+/g;
    we.Callbacks = function(e) {
                ...
                add: function() {
                    return a && (n && !t && (c = a.length - 1, s.push(n)), function t(n) {
                        we.each(n, function(n, o) {
                            be(o) ? e.unique && d.has(o) || a.push(o) : o && o.length && "string" !== i(o) && t(o)
                        })
                                ...
                                var s = this,
                                    ...
                                    d = function() {
                                        ...
                                        if (!(t < a)) {
                                            ...
                                            d = e && ("object" == typeof e || "function" == typeof e) && e.then, be(d) ? o ? d.call(e, r(a, n, c, o), r(a, n, u, o)) : (a++, d.call(e, r(a, n, c, o), r(a, n, u, o), r(a, n, c, n.notifyWith))) : (i !== c && (s = void 0, l = [e]), (o || n.resolveWith)(s, l))
                                        }
                                    },
                                    f = o ? d : function() {
                                        try {
                                            ...
                                            we.Deferred.exceptionHook && we.Deferred.exceptionHook(e, f.stackTrace), t + 1 >= a && (i !== u && (s = void 0, l = [e]), n.rejectWith(s, l))
                                        }
                                    };
        ...
        when: function(e) {
            ...
            if (t <= 1 && (d(e, r.done(a(n)).resolve, r.reject, !t), "pending" === r.state() || be(o[n] && o[n].then))) return r.then();
    ...
    we.fn.ready = function(e) {
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --we.readyWait : we.isReady) || (we.isReady = !0, !0 !== e && --we.readyWait > 0 || qe.resolveWith(ae, [we]))
        }
    }), we.ready.then = qe.then, "complete" === ae.readyState || "loading" !== ae.readyState && !ae.documentElement.doScroll ? e.setTimeout(we.ready) : (ae.addEventListener("DOMContentLoaded", f), e.addEventListener("load", f));
    var Ne = function(e, t, n, o, r, a, s) {
            var l = 0,
                c = e.length,
                u = null == n;
            if ("object" === i(n)) {
            ...
            } else if (void 0 !== o && (r = !0, be(o) || (s = !0), u && (s ? (t.call(e, o), t = null) : (u = t, t = function(e, t, n) {
    ...
    we.extend({
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (o = $e.get(r), 1 === r.nodeType && !He.get(r, "hasDataAttrs"))) {
                    for (n = a.length; n--;) a[n] && 0 === (i = a[n].name).indexOf("data-") && (i = h(i.slice(5)), v(r, i, o[i]));
        ...
        queue: function(e, t, n) {
            var i;
            if (e) return t = (t || "fx") + "queue", i = He.get(e, t), n && (!i || Array.isArray(n) ? i = He.access(e, t, we.makeArray(n)) : i.push(n)), i || []
        },
    ...
    we.fn.extend({
        ...
        toggle: function(e) {
            return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function() {
                _e(this) ? we(this).show() : we(this).hide()
            })
        }
    });
    ...
    we.event = {
        ...
        add: function(e, t, n, i, o) {
            var r, a, s, l, c, u, d, f, p, h, g, m = He.get(e);
            if (m)
                for (n.handler && (n = (r = n).handler, o = r.selector), o && we.find.matchesSelector(et, o), n.guid || (n.guid = we.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
                        return void 0 !== we && we.event.triggered !== t.type ? we.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(Pe) || [""]).length; c--;) p = g = (s = it.exec(t[c]) || [])[1], h = (s[2] || "").split(".").sort(), p && (d = we.event.special[p] || {}, p = (o ? d.delegateType : d.bindType) || p, d = we.event.special[p] || {}, u = we.extend({
                    type: p,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, r), (f = l[p]) || ((f = l[p] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, h, a) || e.addEventListener && e.addEventListener(p, a)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? f.splice(f.delegateCount++, 0, u) : f.push(u), we.event.global[p] = !0)
        },
        remove: function(e, t, n, i, o) {
            var r, a, s, l, c, u, d, f, p, h, g, m = He.hasData(e) && He.get(e);
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(Pe) || [""]).length; c--;)
                    if (s = it.exec(t[c]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p) {
                        for (d = we.event.special[p] || {}, f = l[p = (i ? d.delegateType : d.bindType) || p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = r = f.length; r--;) u = f[r], !o && g !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(r, 1), u.selector && f.delegateCount--, d.remove && d.remove.call(e, u));
                        a && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, m.handle) || we.removeEvent(e, p, m.handle), delete l[p])
                    } else
                        for (p in l) we.event.remove(e, p + t[c], n, i, !0);
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? T : S, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && we.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[we.expando] = !0
    }, we.Event.prototype = {
    ...
    we.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(ve.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || we.isXMLDoc(e)))
                for (a = w(s), i = 0, o = (r = w(e)).length; i < o; i++) P(r[i], a[i]);
            if (t)
                if (n)
                    for (r = r || w(e), a = a || w(s), i = 0, o = r.length; i < o; i++) O(r[i], a[i]);
                else O(e, s);
        ...
        html: function(e) {
            return Ne(this, function(e) {
                ...
                if ("string" == typeof e && !rt.test(e) && !Ye[(Je.exec(e) || ["", ""])[1].toLowerCase()]) {
        ...
        we.fn[e] = function(e) {
            for (var n, i = [], o = we(e), r = o.length - 1, a = 0; a <= r; a++) n = a === r ? this : this.clone(!0), we(o[a])[t](n), ue.apply(i, n.get());
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, a, s = h(t),
                    l = ft.test(t),
                    c = e.style;
                if (l || (t = I(s)), a = we.cssHooks[t] || we.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (o = a.get(e, !1, i)) ? o : c[t];
                "string" == (r = typeof n) && (o = We.exec(n)) && o[1] && (n = b(e, t, o), r = "number"), null != n && n === n && ("number" === r && (n += o && o[3] || (we.cssNumber[s] ? "" : "px")), ve.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function(e, t, n, i) {
            var o, r, a, s = h(t);
            return ft.test(t) || (t = I(s)), (a = we.cssHooks[t] || we.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = N(e, t, i)), "normal" === o && t in ht && (o = ht[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), we.each(["height", "width"], function(e, t) {
        we.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !dt.test(we.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? z(e, t, i) : Xe(e, pt, function() {
                    return z(e, t, i)
                })
            },
            set: function(e, n, i) {
                var o, r = ct(e),
                    ...
                    s = i && $(e, t, i, a, r);
                return a && ve.scrollboxSize() === r.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - $(e, t, "border", !1, r) - .5)), s && (o = We.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = we.css(e, t)), H(e, n, s)
            }
        }
    }), we.cssHooks.marginLeft = F(ve.reliableMarginLeft, function(e, t) {
    ...
    we.Animation = we.extend(Q, {
            ...
            return we.fx.off ? i.duration = 0 : "number" != typeof i.duration && (i.duration in we.fx.speeds ? i.duration = we.fx.speeds[i.duration] : i.duration = we.fx.speeds._default), null != i.queue && !0 !== i.queue || (i.queue = "fx"), i.old = i.complete, i.complete = function() {
                be(i.old) && i.old.call(this), i.queue && we.dequeue(this, i.queue)
            }, i
        }, we.fn.extend({
    ...
    we.fn.extend({
            ...
            if ((t = Y(e)).length)
                for (; n = this[l++];)
                    if (o = G(n), i = 1 === n.nodeType && " " + J(o) + " ") {
                        ...
                        o !== (s = J(i)) && n.setAttribute("class", s)
                    } return this
        },
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : be(e) ? this.each(function(n) {
                ...
                var t, o, r, a;
                if (i)
                    for (o = 0, r = we(this), a = Y(e); t = a[o++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
        ...
        hasClass: function(e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)
                if (1 === n.nodeType && (" " + J(G(n)) + " ").indexOf(t) > -1) return !0;
            return !1
        }
    });
    var St = /\r/g;
    ...
    we.extend(we.event, {
        trigger: function(t, n, i, o) {
            var r, a, s, l, c, u, d, f, p = [i || ae],
                h = he.call(t, "type") ? t.type : t,
                g = he.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = f = s = i = i || ae, 3 !== i.nodeType && 8 !== i.nodeType && !At.test(h + we.event.triggered) && (h.indexOf(".") > -1 && (h = (g = h.split(".")).shift(), g.sort()), c = h.indexOf(":") < 0 && "on" + h, t = t[we.expando] ? t : new we.Event(h, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = g.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : we.makeArray(n, [t]), d = we.event.special[h] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!o && !d.noBubble && !ye(i)) {
                    for (l = d.delegateType || h, At.test(l + h) || (a = a.parentNode); a; a = a.parentNode) p.push(a), s = a;
                    s === (i.ownerDocument || ae) && p.push(s.defaultView || s.parentWindow || e)
                }
                for (r = 0;
                    (a = p[r++]) && !t.isPropagationStopped();) f = a, t.type = r > 1 ? l : d.bindType || h, (u = (He.get(a, "events") || {})[t.type] && He.get(a, "handle")) && u.apply(a, n), (u = c && a[c]) && u.apply && Ie(a) && (t.result = u.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = h, o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(p.pop(), n) || !Ie(i) || c && be(i[h]) && !ye(i) && ((s = i[c]) && (i[c] = null), we.event.triggered = h, t.isPropagationStopped() && f.addEventListener(h, Et), i[h](), t.isPropagationStopped() && f.removeEventListener(h, Et), we.event.triggered = void 0, s && (i[c] = s)), t.result
            }
        },
    ...
    we.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !we(this).is(":disabled") && qt.test(this.nodeName) && !Lt.test(e) && (this.checked || !Qe.test(e))
            }).map(function(e, t) {
                var n = we(this).val();
    ...
    Bt.href = jt.href, we.extend({
        ...
        ajax: function(t, n) {
            ...
            if (v.promise(k), h.url = ((t || h.url || jt.href) + "").replace(zt, jt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Pe) || [""], null == h.crossDomain) {
        ...
        we[t] = function(e, n, i, o) {
            return be(n) && (o = o || i, i = n, n = void 0), we.ajax(we.extend({
                url: e,
                type: t,
                dataType: o,
                data: n,
        ...
        wrapAll: function(e) {
            var t;
            return this[0] && (be(e) && (e = e.call(this[0])), t = we(e, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[0]), t.map(function() {
    ...
    we.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = be(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Qt, "$1" + o) : !1 !== t.jsonp && (t.url += (Rt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
            return a || we.error(o + " was not called"), a[0]
        }, t.dataTypes[0] = "json", r = e[o], e[o] = function() {
            a = arguments
        }, i.always(function() {
            void 0 === r ? we(e).removeProp(o) : e[o] = r, t[o] && (t.jsonpCallback = n.jsonpCallback, Kt.push(o)), a && be(r) && r(a[0]), a = r = void 0
        }), "script"
        ...
        var i, o, r;
        return t || (ve.createHTMLDocument ? ((i = (t = ae.implementation.createHTMLDocument("")).createElement("base")).href = ae.location.href, t.head.appendChild(i)) : t = ae), o = Ee.exec(e), r = !n && [], o ? [t.createElement(o[1])] : (o = k([e], t, r), r && r.length && we(r).remove(), we.merge([], o.childNodes))
    }, we.fn.load = function(e, t, n) {
        var i, o, r, a = this,
            s = e.indexOf(" ");
        return s > -1 && (i = J(e.slice(s)), e = e.slice(0, s)), be(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), a.length > 0 && we.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, o, r, a, s, l, c = we.css(e, "position"),
                u = we(e),
                d = {};
            "static" === c && (e.style.position = "relative"), s = u.offset(), r = we.css(e, "top"), l = we.css(e, "left"), ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1 ? (a = (i = u.position()).top, o = i.left) : (a = parseFloat(r) || 0, o = parseFloat(l) || 0), be(t) && (t = t.call(e, n, we.extend({}, s))), null != t.top && (d.top = t.top - s.top + a), null != t.left && (d.left = t.left - s.left + o), "using" in t ? t.using.call(e, d) : u.css(d)
        }
    }, we.fn.extend({
        offset: function(e) {
        ...
        we.cssHooks[t] = F(ve.pixelPosition, function(e, n) {
            if (n) return n = N(e, t), lt.test(n) ? we(e).position()[t] + "px" : n
        })
    }), we.each({
        Height: "height",
        Width: "width"
        ...
        we.each({
            ...
            we.fn[i] = function(o, r) {
                ...
                return Ne(this, function(t, n, o) {
                    var r;
                    return ye(t) ? 0 === i.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (r = t.documentElement, Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === o ? we.css(t, n, s) : we.style(t, n, o, s)
                }, t, a ? o : void 0, a)
            }
        })
        ...
        var n, i, o;
        if ("string" == typeof t && (n = e[t], t = e, e = n), be(e)) return i = le.call(arguments, 2), o = function() {
            return e.apply(t || this, i.concat(le.call(arguments)))
        }, o.guid = e.guid = e.guid || we.guid++, o
    }, we.holdReady = function(e) {
        e ? we.readyWait++ : we.ready(!0)
    }, we.isArray = Array.isArray, we.parseJSON = JSON.parse, we.nodeName = r, we.isFunction = be, we.isWindow = ye, we.camelCase = h, we.type = i, we.now = Date.now, we.isNumeric = function(e) {
        var t = we.type(e);
    ...
    return we.noConflict = function(t) {
        return e.$ === we && (e.$ = Gt), t && e.jQuery === we && (e.jQuery = Jt), we
    }, t || (e.jQuery = e.$ = we), we
}),
/**
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.form = function(t) {
        ...
        return r.each(function() {
            var p, h, g, m, v, b, y, x, w, C, k, T, S, A, E, j, D, R, O = e(this),
                P = this,
                L = [],
                q = !1;
            R = {
                ...
                refresh: function() {
                    R.verbose("Refreshing selector cache"), p = O.find(k.field), h = O.find(k.group), g = O.find(k.message), m = O.find(k.prompt), v = O.find(k.submit), b = O.find(k.clear), y = O.find(k.reset)
                },
                submit: function() {
                ...
                add: {
                    ...
                    errors: function(e) {
                        R.debug("Adding form error messages", e), R.set.error(), g.html(x.templates.error(e))
                    }
                },
                remove: {
                    prompt: function(t) {
            ...
            f = {
                ...
                open: function(t) {
                    var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t).closest(m.title) : e(this).closest(m.title),
                        o = n.next(k),
                        r = o.hasClass(h.animating);
                    return o.hasClass(h.active) || r ? void f.debug("Accordion already open, skipping", o) : (f.debug("Opening accordion content", n), p.onOpening.call(o), p.exclusive && f.closeOthers.call(n), n.addClass(h.active), o.stop(!0, !0).addClass(h.animating), p.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
                        animation: "fade in",
                        queue: !1,
                        useFailSafe: !0,
                        debug: p.debug,
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.checkbox = function(o) {
        ...
        return a.each(function() {
            ...
            p = {
                ...
                should: {
                    allowCheck: function() {
                        return p.is.determinate() && p.is.checked() && !p.should.forceCallbacks() ? (p.debug("Should not allow check, checkbox is already checked"), !1) : !1 !== h.beforeChecked.apply(T) || (p.debug("Should not allow check, beforeChecked cancelled"), !1)
                    },
                    allowUncheck: function() {
                        return p.is.determinate() && p.is.unchecked() && !p.should.forceCallbacks() ? (p.debug("Should not allow uncheck, checkbox is already unchecked"), !1) : !1 !== h.beforeUnchecked.apply(T) || (p.debug("Should not allow uncheck, beforeUnchecked cancelled"), !1)
                    },
                    allowIndeterminate: function() {
                        return p.is.indeterminate() && !p.should.forceCallbacks() ? (p.debug("Should not allow indeterminate, checkbox is already indeterminate"), !1) : !1 !== h.beforeIndeterminate.apply(T) || (p.debug("Should not allow indeterminate, beforeIndeterminate cancelled"), !1)
                    },
                    allowDeterminate: function() {
                        return p.is.determinate() && !p.should.forceCallbacks() ? (p.debug("Should not allow determinate, checkbox is already determinate"), !1) : !1 !== h.beforeDeterminate.apply(T) || (p.debug("Should not allow determinate, beforeDeterminate cancelled"), !1)
                    },
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.dropdown = function(o) {
        ...
        return a.each(function(g) {
            ...
            k = {
                ...
                destroy: function() {
                    k.verbose("Destroying previous dropdown", M), k.remove.tabbable(), M.off(N).removeData(F), B.off(N), s.off(y), k.disconnect.menuObserver(), k.disconnect.selectObserver()
                },
                observeChanges: function() {
                ...
                select: {
                    firstUnfiltered: function() {
                        k.verbose("Selecting first non-filtered element"), k.remove.selectedItem(), _.not(P.unselectable).not(P.addition + P.hidden).eq(0).addClass(S.selected)
                    },
                ...
                setup: {
                    ...
                    select: function() {
                        ...
                        k.debug("Dropdown initialized on a select", t), M.is("select") && (U = M), U.parent(P.dropdown).length > 0 ? (k.debug("UI dropdown already exists. Creating dropdown menu only"), M = U.closest(P.dropdown), k.has.menu() || k.create.menu(), B = M.children(P.menu), k.setup.menu(t)) : (k.debug("Creating entire dropdown from select"), M = e("<div />").attr("class", U.attr("class")).addClass(S.selection).addClass(S.dropdown).html(q.dropdown(t)).insertBefore(U), U.hasClass(S.multiple) && !1 === U.prop("multiple") && (k.error(L.missingMultiple), U.prop("multiple", !0)), U.is("[multiple]") && k.set.multiple(), U.prop("disabled") && (k.debug("Disabling dropdown"), M.addClass(S.disabled)), U.removeAttr("class").detach().prependTo(M)), k.refresh()
                    },
                    menu: function(e) {
                        B.html(q.menu(e, E)), _ = B.find(P.item)
                    },
                    reference: function() {
                ...
                refreshSelectors: function() {
                    k.verbose("Refreshing selector cache"), H = M.find(P.text), $ = M.find(P.search), U = M.find(P.input), V = M.find(P.icon), W = M.prev().find(P.text).length > 0 ? M.prev().find(P.text) : M.prev(), B = M.children(P.menu), _ = B.find(P.item)
                },
                refreshData: function() {
                    k.verbose("Refreshing cached metadata"), _.removeData(D.text).removeData(D.value)
                },
                clearData: function() {
                    k.verbose("Clearing metadata"), _.removeData(D.text).removeData(D.value), M.removeData(D.defaultText).removeData(D.defaultValue).removeData(D.placeholderText)
                },
                toggle: function() {
                ...
                bind: {
                    ...
                    touchEvents: function() {
                        k.debug("Touch device detected binding additional touch events"), k.is.searchSelection() || k.is.single() && M.on("touchstart" + N, k.event.test.toggle), B.on("touchstart" + N, P.item, k.event.item.mouseenter)
                    },
                ...
                filterItems: function(t) {
                    ...
                    })), k.debug("Showing only matched items", n), k.remove.filteredItem(), o && _.not(o).addClass(S.filtered)
                },
                ...
                event: {
                    ...
                    keydown: function(e) {
                        var t = e.which;
                        if (k.is.inObject(t, j)) {
                            var n, i = _.not(P.unselectable).filter("." + S.selected).eq(0),
                            ...
                            if (T.allowAdditions && T.hideAdditions && (t == j.enter || p) && f && (k.verbose("Selecting item from keyboard shortcut", r), k.event.item.click.call(r, e), k.is.searchSelection() && k.remove.searchTerm()), k.is.visible()) {
                                if ((t == j.enter || p) && (t == j.enter && d && u && !T.allowCategorySelection ? (k.verbose("Pressed enter on unselectable category, opening sub menu"), t = j.rightArrow) : f && (k.verbose("Selecting item from keyboard shortcut", r), k.event.item.click.call(r, e), k.is.searchSelection() && k.remove.searchTerm()), e.preventDefault()), d && (t == j.leftArrow && l[0] !== B[0] && (k.verbose("Left key pressed, closing sub-menu"), k.animate.hide(!1, l), r.removeClass(S.selected), l.closest(P.item).addClass(S.selected), e.preventDefault()), t == j.rightArrow && u && (k.verbose("Right key pressed, opening sub-menu"), k.animate.show(!1, s), r.removeClass(S.selected), s.find(P.item).eq(0).addClass(S.selected), e.preventDefault())), t == j.upArrow) {
                                    if (n = d && c ? r.prevAll(P.item + ":not(" + P.unselectable + ")").eq(0) : _.eq(0), a.index(n) < 0) return k.verbose("Up key pressed but reached top of current menu"), void e.preventDefault();
                                ...
                                if (t == j.downArrow) {
                                    if (n = d && c ? n = r.nextAll(P.item + ":not(" + P.unselectable + ")").eq(0) : _.eq(0), 0 === n.length) return k.verbose("Down key pressed but reached bottom of current menu"), void e.preventDefault();
                                    k.verbose("Down key pressed, changing active item"), _.removeClass(S.selected), n.addClass(S.selected), k.set.scrollPosition(n), T.selectOnKeydown && k.is.single() && k.set.selectedItem(n), e.preventDefault()
                                }
                ...
                get: {
                    ...
                    item: function(t, n) {
                        var o, r, a = !1;
                        return t = t !== i ? t : k.get.values() !== i ? k.get.values() : k.get.text(), o = r ? t.length > 0 : t !== i && null !== t, r = k.is.multiple() && e.isArray(t), n = "" === t || 0 === t || n || !1, o && _.each(function() {
                            var o = e(this),
                ...
                set: {
                    ...
                    selectedLetter: function(t) {
                        var n, i = _.filter("." + S.selected),
                            o = i.length > 0 && k.has.firstLetter(i, t),
                            r = !1;
                        o && (n = i.nextAll(_).eq(0), k.has.firstLetter(n, t) && (r = n)), r || _.each(function() {
                ...
                add: {
                    ...
                    userSuggestion: function(e) {
                        var t, n = B.children(P.addition),
                            i = k.get.item(e),
                            o = i && i.not(P.addition).length,
                            r = n.length > 0;
                        if (!T.useLabels || !k.has.maxSelections()) {
                            if ("" === e || o) return void n.remove();
                            r ? (n.data(D.value, e).data(D.text, e).attr("data-" + D.value, e).attr("data-" + D.text, e).removeClass(S.filtered), T.hideAdditions || (t = T.templates.addition(k.add.variables(A.addResult, e)), n.html(t)), k.verbose("Replacing user suggestion with new value", n)) : (n = k.create.userChoice(e), n.prependTo(B), k.verbose("Adding item choice to menu corresponding with user choice addition", n)), T.hideAdditions && !k.is.allFiltered() || n.addClass(S.selected).siblings().removeClass(S.selected), k.refreshItems()
                        }
                    },
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.modal = function(o) {
        ...
        return a.each(function() {
            ...
            T = {
                ...
                invoke: function(t, n, o) {
                    var a, s, l, c = F;
                    return n = n || g, o = N || o, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function(n, o) {
                        var r = n != a ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(c[r]) && n != a) c = c[r];
                        else {
                            if (c[r] !== i) return s = c[r], !1;
            ...
            }, h ? (F === i && T.initialize(), T.invoke(p)) : (F !== i && F.invoke("destroy"), T.initialize())
        }), r !== i ? r : this
    }, e.fn.modal.settings = {
        name: "Modal",
        namespace: "modal",
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.popup = function(o) {
        ...
        return a.each(function() {
            ...
            }, h ? (I === i && x.initialize(), x.invoke(p)) : (I !== i && I.invoke("destroy"), x.initialize())
        }), r !== i ? r : this
    }, e.fn.popup.settings = {
        name: "Popup",
        silent: !1,
            ...
            p = {
                ...
                event: {
                    ...
                    result: {
                        ...
                        click: function(n) {
                            ...
                            return e.isFunction(h.onSelect) && !1 === h.onSelect.call(R, u, c) ? (p.debug("Custom onSelect callback cancelled default select action"), void(P = !0)) : (p.hideResults(), l && p.set.value(l), void(a && (p.verbose("Opening search link found in result", r), "_blank" == s || n.ctrlKey ? t.open(a) : t.location.href = a)))
                        }
                    }
                },
                ...
                get: {
                    ...
                    result: function(t, n) {
                        var o = ["title", "id"],
                            r = !1;
                        return t = t !== i ? t : p.get.value(), n = n !== i ? n : p.get.results(), "category" === h.type ? (p.debug("Finding result that matches", t), e.each(n, function(n, i) {
                ...
                query: function() {
                    var t = p.get.value(),
                        n = p.read.cache(t);
                    p.has.minimumCharacters() ? (n ? (p.debug("Reading result from cache", t), p.save.results(n.results), p.addResults(n.html), p.inject.id(n.results)) : (p.debug("Querying for", t), e.isPlainObject(h.source) || e.isArray(h.source) ? p.search.local(t) : p.can.useAPI() ? p.search.remote(t) : p.error(x.source)), h.onSearchQuery.call(R, t)) : p.hideResults()
                },
                search: {
                    local: function(e) {
                    ...
                    object: function(t, n, o) {
                        ...
                        return n = n || h.source, o = o !== i ? o : h.searchFields, e.isArray(o) || (o = [o]), n === i || !1 === n ? (p.error(x.source), []) : (e.each(o, function(i, o) {
                            e.each(n, function(e, n) {
                                "string" == typeof n[o] && (-1 !== n[o].search(l) ? c(r, n) : h.searchFullText && p.fuzzySearch(t, n[o]) && c(a, n))
                            })
                        }), e.merge(r, a))
                    }
                },
                ...
                has: {
                    minimumCharacters: function() {
                        return p.get.value().length >= h.minCharacters
                    }
                },
                clear: {
                    cache: function(e) {
                ...
                addResults: function(t) {
                    return e.isFunction(h.onResultsAdd) && !1 === h.onResultsAdd.call(E, t) ? (p.debug("onResultsAdd callback cancelled default action"), !1) : void(t ? (E.html(t), p.refreshResults(), h.selectFirstResult && p.select.firstResult(), p.showResults()) : p.hideResults())
                },
                ...
                generateResults: function(t) {
                    ...
                    var n = h.templates[h.type],
                        ...
                        r = "";
                    return i || o ? (h.maxResults > 0 && (i ? "standard" == h.type && p.error(x.maxResults) : t[b.results] = t[b.results].slice(0, h.maxResults)), e.isFunction(n) ? r = n(t, b) : p.error(x.noTemplate, !1)) : h.showNoResults && (r = p.displayMessage(x.noResults, "empty")), h.onResults.call(R, t), r
                },
            ...
            b = {
                ...
                set: {
                    ...
                    loading: function(e) {
                        ...
                        t.hasClass(w.loading) || (b.verbose("Setting loading state for", t), t.addClass(w.loading).siblings(g).removeClass(w.active + " " + w.loading), t.length > 0 && x.onRequest.call(t[0], e))
                    },
                    state: function(t) {
                        e.address.value(t)
                    }
                ...
                changeTab: function(n) {
                    ...
                    n = b.utilities.arrayToPath(a), e.each(a, function(t, i) {
                        ...
                        if (b.verbose("Looking for tab", i), p) {
                            ...
                            if (-1 != n.search("/") || "" === n) return b.error(T.missingTab, E, h, f), !1;
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.transition = function() {
        ...
        return t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame, r.each(function(t) {
            ...
            w = {
                initialize: function() {
                    p = w.get.settings.apply(k, c), m = p.className, g = p.error, v = p.metadata, x = "." + p.namespace, y = "module-" + p.namespace, h = C.data(y) || w, b = w.get.animationEndEvent(), f && (f = w.invoke(u)), !1 === f && (w.verbose("Converted arguments into settings object", p), p.interval ? w.delay(p.animate) : w.animate(), w.instantiate())
                },
                instantiate: function() {
            ...
            return k(n, e), n.prototype.changeLanguage = function(e) {
                ...
                if (c && "string" != typeof c && d.indexOf(u) < 0 && (!p || "[object Array]" !== u)) {
                    ...
                    if (t.keySeparator || this.options.keySeparator) {
                        ...
                        for (var g in c) c.hasOwnProperty(g) && (h[g] = this.translate("" + o + n + g, C({}, t, {
                            joinArrays: !1,
                            ns: r
                        })));
                        c = h
...
var keyPlurals = {
    ...
    singlePageSnippets = {
        ...
        "/clans": function() {
            ...
            function checkRelaxMania(mode, relax) {
                if (relax == 1) {
                    for (i = 0; i <= 3; i++) {
                        $(`#mode-menu > .item[data-mode='${i}']`).removeClass('disabled')
                    }
                    $("#mode-menu > .item[data-mode='3']").addClass("disabled")
                } else if (relax == 2) {
                    for (i = 1; i <= 3; i++) {
                        $(`#mode-menu > .item[data-mode='${i}']`).addClass('disabled')
                    }
                } else {
                    for (i = 0; i <= 3; i++) {
                        $(`#mode-menu > .item[data-mode='${i}']`).removeClass('disabled')
                ...
                if (mode === 3) {
                    $("#rx-menu > .item[data-rx='1']").addClass('disabled')
                    $("#rx-menu > .item[data-rx='2']").addClass('disabled')
                } else if (mode === 1 || mode === 2) {
                    $("#rx-menu > .item[data-rx='2']").addClass('disabled')
                } else {
                    $("#rx-menu > .item[data-rx='1']").removeClass('disabled')
                    $("#rx-menu > .item[data-rx='2']").removeClass('disabled')
                }
            }
            ...
            function e() {
                ...
                if (sort === "1s") {
                    api("clans/stats/first", {
                        ...
                        e.clans.forEach(function(e) {
                            n.append($("<tr class='l-clan' />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/c/" + e.clan + '?mode=' + favouriteMode + '&rx=' + rx  + "' title='View clan'>" + escapeHTML(`[${e.tag}] ${e.name}`) + "</a>"), $("<td class='center aligned' />").html(addCommas(e.count))))
                        });
                ...
                api("clans/stats/all", {
                    ...
                    var i = 0;
                    e.clans.forEach(function(e) {
                        n.append($("<tr class='l-clan' />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/c/" + e.id + '?mode=' + favouriteMode + '&rx=' + rx + "' title='View clan'>" + escapeHTML(e.name) + "</a>"), $("<td class='center aligned' />").html(t(e.chosen_mode.ranked_score, e.chosen_mode.pp)), $("<td class='center aligned' />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), $("<td class='center aligned' />").html(addCommas(e.chosen_mode.playcount))))
                    });
                    disableSimplepagButtons(e.clans.length < 50)
                })
            }
            page = 0 === page ? 1 : page, $("#sort-menu ." + ("1s" === sort ? 0 : 1) + ".item").addClass("active"), $("#rx-menu ." + (1 === rx ? 1 : 0) + ".item").addClass("active"), e(), setupSimplepag(e), $("#mode-menu .item").click(function(t) {
                t.preventDefault(), $("#mode-menu .active.item").removeClass("active"), $(this).addClass("active"), favouriteMode = $(this).data("mode"), page = 1, checkRelaxMania(favouriteMode, rx), e()
            }), $("#rx-menu .item").click(function(t) {
                t.preventDefault(), $("#rx-menu .active.item").removeClass("active"), $(this).addClass("active"), rx = $(this).data("rx"), page = 1, checkRelaxMania(favouriteMode, rx), e()
            })
        },
        "/leaderboard": function() {
            function e() {
                var e = window.location;
                window.history.replaceState("", document.title, e.pathname + "?mode=" + favouriteMode + "&p=" + page + "&rx=" + rx + "&sort=" + sort + ("" != country ? "&country=" + encodeURI(country) : "") + e.hash), api("leaderboard", {
                    mode: favouriteMode,
                    p: page,
                    l: 50,
                    country: country,
                    ...
                    e.users.forEach(function(e) {
                        codepoints = countryToCodepoints(e.country)
                        n.append($("<tr class='l-player' />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<div class='flag-container'><a href='/leaderboard?mode="+ favouriteMode +"&rx="+ rx +"&country="+e.country.toLowerCase()+"'><img src='https://twemoji.maxcdn.com/v/latest/svg/" + codepoints + ".svg' class='new-flag nopad'></img></a><a href='/u/" + e.id + "?mode=" + favouriteMode + "&rx=" + rx + "'>" + escapeHTML(e.username) + "</a></div>"), $("<td class='center aligned' />").html(t(e.chosen_mode.ranked_score, e.chosen_mode.pp, sort === "score")), $("<td class='center aligned' />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), $("<td class='center aligned' />").html(addCommas(e.chosen_mode.playcount) + " <i title='" + T("Why, LOVE, of course!") + "'>(lv. " + e.chosen_mode.level.toFixed(0) + ")</i>")))
                    }), disableSimplepagButtons(e.users.length < 50)
                })
            }

            function t(e, t, s) {
                return 0 === t ? "<b>" + addCommas(e) + "</b>" : (s ? "<b>" + addCommas(e) + "</b> (" + addCommas(t) + "pp)" : "<b>" + addCommas(t) + "pp</b> (" + addCommas(e) + ")")
            }
            ...
            if (country) $(`[data-country=${country}]`).addClass("active")
            page = 0 === page ? 1 : page, $("#country-chooser-modal").click(function() {
                $(".ui.modal").modal("show")
            }), $(".lb-country").click(function() {
                country = $(this).data("country"), $("#country-menu .active.item").removeClass("active"), $(this).addClass("active"), page = 1, $(".ui.modal").modal("hide"), e()
            }), e(), setupSimplepag(e), $("#mode-menu .item").click(function(t) {
                t.preventDefault(), $("#mode-menu .active.item").removeClass("active"), $("#country-menu .active.item").removeClass("active"), $(this).addClass("active"), favouriteMode = $(this).data("mode"), country = "", page = 1, checkRelaxMania(favouriteMode, rx), e()
            }), $("#rx-menu .item").click(function(t) {
                t.preventDefault(), $("#rx-menu .active.item").removeClass("active"), $("#country-menu .active.item").removeClass("active"), $(this).addClass("active"), rx = $(this).data("rx"), country = "", page = 1, checkRelaxMania(favouriteMode, rx), e()
            })
        },
        "/friends": function() {
            $(".ui.compact.labeled.button").click(function() {
                var e = $(this),
                    t = "1" === e.data("deleted") ? "add" : "del";
                console.log(t), e.addClass("disabled"), api("friends/" + t, {
                    user: +e.data("userid")
                }, function(t) {
                    e.removeClass("disabled"), e.data("deleted", t.friend ? "0" : "1"), e.removeClass("green red blue"), e.addClass(t.friend ? t.mutual ? "red" : "green" : "blue"), e.find(".icon").removeClass("minus plus heart").removeClass("green red blue").addClass(t.friend ? t.mutual ? "red heart" : "green minus" : "blue plus"), e.find("span").text(t.friend ? T(t.mutual ? "Unmutual" : "Remove") : T("Add"))
                }, !0)
            })
        },
        "/team": function() {
        ...
        "/settings/clansettings": function() {
            $("#ginvite").click(function(e) {
                e.preventDefault();
                api("clans/invite", {}, function(t) {
                    if (!t.invite) return;
                    console.log(t);
                    $("#invin").attr("value", t.invite);
                ...
                var t = formToObject($(this)),
                    n = $(this);
                return api("clans/settings", t, function(e) {
                    if (e.message === "tag already exists") {
                        showMessage("error", "A clan with that tag already exists!"), n.removeClass("loading");
                        return
                    }
                    showMessage("success", "Clan Settings have been saved."), n.removeClass("loading")
                }, !0), !1
            })
        },
        "/support": function() {
...
$(document).ready(function() {
    ...
    }), $.timeago.settings.allowFuture = !0, $("time.timeago").timeago(), $("#language-select").click(function() {
...
var modsString = ["NF", "EZ", "TD", "HD", "HR", "SD", "DT", "RX", "HT", "NC", "FL", "AU", "SO", "AP", "PF", "K4", "K5", "K6", "K7", "K8", "K9", "RN", "LM", "K9", "K0", "K1", "K3", "K2", "V2"],

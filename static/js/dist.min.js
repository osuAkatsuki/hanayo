    ...
    singlePageSnippets = {
        ...
        "/leaderboard": function() {
            ...
            page = 0 === page ? 1 : page, $("#country-chooser-modal").click(function() {
                ...
                t.preventDefault(), $("#mode-menu .active.item").removeClass("active"), $(this).addClass("active"), favouriteMode = $(this).data("mode"), country = "", page = 1, checkRelaxMania(favouriteMode, rx), e()
            }), $("#rx-menu .item").click(function(t) {
                t.preventDefault(), $("#rx-menu .active.item").removeClass("active"), $(this).addClass("active"), rx = $(this).data("rx"), country = "", page = 1, checkRelaxMania(favouriteMode, rx), e()
            })
        },
        "/friends": function() {

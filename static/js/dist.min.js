    ...
    singlePageSnippets = {
        ...
        "/clans": function() {
                ...
                if (sort === "1s") {
                    api("clans/stats/first", {
                        ...
                        e.clans.forEach(function(e) {
                            n.append($("<tr class='l-clan' />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/c/" + e.clan + '?mode=' + favouriteMode + (0 === rx ? '' : '&rx=1') + "' title='View clan'>" + escapeHTML(`[${e.tag}] ${e.name}`) + "</a>"), $("<td class='center aligned' />").html(addCommas(e.count))))
                        });
            ...
            page = 0 === page ? 1 : page, $("#sort-menu ." + ("1s" === sort ? 0 : 1) + ".item").addClass("active"), $("#rx-menu ." + (1 === rx ? 1 : 0) + ".item").addClass("active"), e(), setupSimplepag(e), $("#mode-menu .item").click(function(t) {
                t.preventDefault(), $("#mode-menu .active.item").removeClass("active"), $(this).addClass("active"), favouriteMode = $(this).data("mode"), page = 1, e()
            }), $("#rx-menu .item").click(function(t) {
                t.preventDefault(), $("#rx-menu .active.item").removeClass("active"), $(this).addClass("active"), rx = $(this).data("rx"), page = 1, e()
            })
        },
        "/leaderboard": function() {
            ...
            page = 0 === page ? 1 : page, $("#rx-menu ." + (rx === 1 ? 1 : 0) + ".item").addClass("active"), $("#country-chooser-modal").click(function() {
                $(".ui.modal").modal("show")

        ...
        "/friends": function() {
            $(".ui.compact.labeled.button").click(function() {
                ...
                console.log(t), e.addClass("disabled"), api("friends/" + t, {
                    ...
                    e.removeClass("disabled"), e.data("deleted", t.friend ? "0" : "1"), e.removeClass("green red blue"), e.addClass(t.friend ? t.mutual ? "red" : "green" : "blue"), e.find(".icon").removeClass("minus plus heart").addClass(t.friend ? t.mutual ? "heart" : "minus" : "plus"), e.find("span").text(t.friend ? T(t.mutual ? "Unmutual" : "Remove") : T("Add"))
                }, !0)
            })
        },
        "/team": function() {

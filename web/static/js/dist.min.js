...
function api(e, t, n, i, o) {
    ...
    $.ajax({
        method: o ? "POST" : "GET",
        dataType: "json",
        url: hanayoConf.baseAPI + "/" + e,
        data: o ? JSON.stringify(t) : t,
        contentType: o ? "application/json; charset=utf-8" : "",
        success: function(e) {
            if (200 != e.code) {
                if (l == 'profile-history/rank' || l == 'profile-history/pp' || l == 'profile-history/peak-rank') {
                    n(e)
                    return
                }
...
var keyPlurals = {
    ...
    singlePageSnippets = {
        "/": function () {
            window.amplitude.getInstance().init('api_key', null, null, function (instance) {

...
function api(e, t, n, i, o) {
    ...
    $.ajax({
        ...
        success: function(e) {
            if (200 != e.code) {
                if (l == 'profile-history/rank' || l == 'profile-history/pp') {
                    n(e)
                    return
                }
    ...
    singlePageSnippets = {
        "/clans": function() {
            ...
            page = 0 === page ? 1 : page, $("#sort-menu ." + ("1s" === sort ? 0 : 1) + ".item").addClass("active"), $("#rx-menu ." + (1 === rx ? 1 : 0) + ".item").addClass("active"), e(), setupSimplepag(e), $("#mode-menu .item").click(function(t) {
                t.preventDefault(), $("#mode-menu .active.item").removeClass("active"), $(this).addClass("active"), favouriteMode = $(this).data("mode"), page = 1, toggleModeAvailability(favouriteMode, rx), e()
            }), $("#rx-menu .item").click(function(t) {
                t.preventDefault(), $("#rx-menu .active.item").removeClass("active"), $(this).addClass("active"), rx = $(this).data("rx"), page = 1, toggleModeAvailability(favouriteMode, rx), e()
            })
        },
        "/leaderboard": function() {
            ...
            page = 0 === page ? 1 : page, $("#country-chooser-modal").click(function() {
                ...
                t.preventDefault(), $("#mode-menu .active.item").removeClass("active"), $("#country-menu .active.item").removeClass("active"), $(this).addClass("active"), favouriteMode = $(this).data("mode"), country = "", page = 1, toggleModeAvailability(favouriteMode, rx), e()
            }), $("#rx-menu .item").click(function(t) {
                t.preventDefault(), $("#rx-menu .active.item").removeClass("active"), $("#country-menu .active.item").removeClass("active"), $(this).addClass("active"), rx = $(this).data("rx"), country = "", page = 1, toggleModeAvailability(favouriteMode, rx), e()
            })
        },
        "/friends": function() {

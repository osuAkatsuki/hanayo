...
type Settings struct {
	...
	INTERNAL_AVATARS_SERVICE_BASE_URL  string
	RESTRICTED_AVATARS_SERVICE_API_KEY string
...
func LoadSettings() Settings {
	...
	settings.INTERNAL_AVATARS_SERVICE_BASE_URL = getEnv("INTERNAL_AVATARS_SERVICE_BASE_URL")
	settings.RESTRICTED_AVATARS_SERVICE_API_KEY = getEnv("RESTRICTED_AVATARS_SERVICE_API_KEY")

...
var forbiddenUsernames = []string{
	...
	"mikuia", "ameo", "tatsumaki", "cmyui", "solis", "rumoi", "frostidrinks", "cursordance", "paparkes", "daniel", "flyingtuna", "walkingtuna",
	"nathan on osu", "justice", "child", "eb", "kalzo", "ebenezer", "solomon", "murmurtwins", "ggm9", "kaguya", "unspoken mattay", "mattay",
	"parkourwizard", "woey", "trafis", "klug", "c o i n", "varvalian", "mismagius", "nameless player", "mbmasher", "okinamo", "knalli", "obtio",
